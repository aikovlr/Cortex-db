import { integer, pgTable, varchar, timestamp, type PgColumn } from "drizzle-orm/pg-core";
...
export const usuarioTable = pgTable('usuario', {
    ...
    id_role_fk: integer("id_role_fk")
        .notNull()
        .references((): PgColumn => roleTable.id_role, { onDelete: "restrict" }),
    id_avatar_fk: integer("id_avatar_fk")
        .references((): PgColumn => anexoTable.id_anexo, { onDelete: "set null" })
});
...
export const anexoTable = pgTable('anexo', {
    ...
    id_usuario_envio_fk: integer('id_usuario_envio_fk')
        .notNull()
        .references((): PgColumn => usuarioTable.id_usuario, { onDelete: 'restrict' }),
